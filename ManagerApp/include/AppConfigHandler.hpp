...
public:
    ...
    */
    const std::vector<std::string_view> getAllAppsName();
    ...
    */
    const std::string_view getAppPath(const std::string_view &app_name);
    ...
    */
    const std::vector<std::string_view> getAppParams(const std::string_view &app_name);
};